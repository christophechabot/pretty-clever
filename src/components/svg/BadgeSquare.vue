<template>
  <div :class="{ 'badge-square': true,  highlighted: highlighted }">
    <div :class="`badge-square-container ${obj.color}-bg`">
      <div class="badge-square-content">
        <span
          class="white-color"
          v-if="obj.type === 'plusOne'">
          +1
        </span>
        <span
          class="white-color"
          v-if="obj.type === 'blue' || obj.type === 'green'">
          X
        </span>
        <span
          class="black-color"
          v-if="obj.type === 'yellow'">
          X
        </span>
        <svg
          class="reroll"
          v-if="obj.type === 'reroll'"
          viewBox="0 0 341.973 341.973">
          <path style="fill:currentColor;" d="M113.08,107.477c4.079-0.72,6.802-4.61,6.082-8.689l-3.477-19.695
          ...
          <path style="fill:currentColor;" d="M341.143,75.309c-0.911-1.769-2.486-3.104-4.379-3.711L251.061,44.12
          ...
          <path style="fill:currentColor;" d="M136.724,197.181c-1.468-1.342-3.408-2.046-5.396-1.958c-1.987,0.089-3.858,0.963-5.2,2.431
...
<style lang="scss">
  ...
  .badge-square {
    ...
    box-shadow: 2px 2px 8px 0px rgba($white, 0.75);
    &.highlighted {
      background-color: $black;
      box-shadow: 2px 2px 8px 0px rgba($black, 0.75);
    }
